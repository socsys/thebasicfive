...
echo $sudoPW | sudo -S tcpdump -i eth0 -s 96 -w ./$dirname/"iperf_udp_"$current_time".pcap" &
tcpdump_pid=$!
...
echo $sudoPW | sudo -S tcpdump -i eth0 -s 96 -w ./$dirname/"iperf_tcp_cubic_"$current_time".pcap" &
tcpdump_pid=$!
...
echo $sudoPW | sudo -S tcpdump -i eth0 -s 96 -w ./$dirname/"iperf_tcp_bbr_"$current_time".pcap" &
tcpdump_pid=$!
...
echo $sudoPW | sudo -S tcpdump -i eth0 -s 96 -w ./$dirname/"iperf_tcp_illinois_"$current_time".pcap" &
tcpdump_pid=$!
